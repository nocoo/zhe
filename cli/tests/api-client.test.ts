...
describe("ApiClient", () => {
  ...
  describe("listLinks", () => {
    it("returns links from API", async () => {
      const links = [{ id: 1, slug: "test", originalUrl: "https://example.com" }];
      mockFetch.mockResolvedValueOnce({
        ok: true,
        status: 200,
        headers: new Headers(),
      ...
      expect(options.headers).toHaveProperty("Authorization", "Bearer zhe_testkey");
    });
  ...
  describe("createFolder", () => {
    ...
    it("throws on 400 error", async () => {
      ...
      const client = new ApiClient("zhe_testkey");
      await expect(client.createFolder({ name: "" })).rejects.toThrow(ApiClientError);
    });
  });
  ...
  describe("updateFolder", () => {
    ...
    it("throws ApiClientError on 404", async () => {
      ...
      const client = new ApiClient("zhe_testkey");
      await expect(client.updateFolder("missing", { name: "x" })).rejects.toThrow(ApiClientError);
    });
  });
  ...
  describe("deleteFolder", () => {
    ...
    it("throws ApiClientError on 404", async () => {
      ...
      const client = new ApiClient("zhe_testkey");
      await expect(client.deleteFolder("missing")).rejects.toThrow(ApiClientError);
    });
  });

  describe("listTags", () => {
    it("returns tags from API", async () => {
      const tags = [{ id: "tag-1", name: "Important", color: "#ff0000", createdAt: "2026-01-01" }];
      mockFetch.mockResolvedValueOnce({
        ok: true,
        status: 200,
        headers: new Headers(),
  ...
  describe("createTag", () => {
    ...
    it("throws on 400 error", async () => {
      ...
      const client = new ApiClient("zhe_testkey");
      await expect(client.createTag({ name: "", color: "#ffffff" })).rejects.toThrow(
        ApiClientError,
      );
    });
  });
  ...
  describe("updateTag", () => {
    ...
    it("throws ApiClientError on 404", async () => {
      ...
      const client = new ApiClient("zhe_testkey");
      await expect(client.updateTag("missing", { name: "x" })).rejects.toThrow(ApiClientError);
    });
  });
  ...
  describe("createIdea", () => {
    ...
    it("throws ApiClientError on 400 validation error", async () => {
      ...
      const client = new ApiClient("zhe_testkey");
      await expect(client.createIdea({ content: "Test", tagIds: ["invalid"] })).rejects.toThrow(
        ApiClientError,
      );
    });
  });
