...
async function resolveSingleTag(client: ApiClient, tag: string): Promise<string[]> {
 ...
 */
async function buildUpdatePayload(client: ApiClient, args: UpdateArgs): Promise<UpdateLinkRequest> {
