 ...
 *
 * Manual trigger only — no cron. Primary sync happens inline on link
 * create/update/delete; this endpoint is a consistency safety net called
 * on server startup or on-demand from the dashboard.
 *
