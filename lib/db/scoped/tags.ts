...
import { rowToLinkTag, rowToTag } from "../mappers";
import type { LinkTag, Tag } from "../schema";
...
export async function addTagToLink(
  ...
  await executeD1Query("INSERT OR IGNORE INTO link_tags (link_id, tag_id) VALUES (?, ?)", [
    linkId,
    tagId,
  ]);
  return true;
