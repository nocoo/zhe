...
const mockService: DashboardService = {
  ...
  ensureTodosLoaded: vi.fn().mockResolvedValue(undefined),
  refreshTodos: vi.fn().mockResolvedValue(undefined),
  handleTodoCreated: vi.fn(),
  handleTodoDeleted: vi.fn(),
...
const inboxLink1 = makeLink({
  id: 1,
  metaTitle: "Inbox Link 1",
  originalUrl: "https://example.com/1",
});
const inboxLink2 = makeLink({
  id: 2,
  metaTitle: "Inbox Link 2",
  originalUrl: "https://example.com/2",
  metaFavicon: null,
  metaDescription: null,
});
const categorizedLink = makeLink({
  id: 3,
  metaTitle: "Categorized Link",
...
describe("InboxTriage (interactions)", () => {
  ...
  describe("save button click", () => {
    it("triggers save action when clicked", async () => {
      ...
      (updateLink as ReturnType<typeof vi.fn>).mockResolvedValue({
        success: true,
        data: { ...inboxLink1, folderId: null },
      });
      render(<InboxTriage />);
