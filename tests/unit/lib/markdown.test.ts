...
import { generateExcerpt, stripMarkdown } from "@/lib/markdown";
...
The end.`;
    ...
    const expected =
      "My Idea This is a bold statement with emphasis. Details Point one Point two Check this link for more. A quote The end.";
