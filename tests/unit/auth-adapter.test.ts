...
describe("D1Adapter", () => {
  ...
  describe("createUser", () => {
    it("inserts a new user and returns it", async () => {
      ...
      expect(mockExecute).toHaveBeenCalledWith(expect.stringContaining("INSERT INTO users"), [
        FIXED_UUID,
        "Alice",
        "alice@example.com",
        NOW,
        "https://img.example.com/alice.png",
      ]);
  ...
  describe("createSession", () => {
    it("inserts session and returns input", async () => {
      ...
      expect(mockExecute).toHaveBeenCalledWith(expect.stringContaining("INSERT INTO sessions"), [
        FIXED_UUID,
        "tok-abc",
        "user-1",
        NOW,
  ...
  describe("deleteSession", () => {
    it("deletes by sessionToken", async () => {
      ...
      expect(mockExecute).toHaveBeenCalledWith("DELETE FROM sessions WHERE sessionToken = ?", [
        "tok-abc",
      ]);
    });
  });
