...
test.describe("Overview page", () => {
  ...
  test("stat cards display non-zero link stats", async ({ page }) => {
    ...
    const totalLinksCard = linksSection.locator(
      '[data-testid="stat-card"][data-stat-label="总链接数"]',
    );
    ...
    const totalClicksCard = linksSection.locator(
      '[data-testid="stat-card"][data-stat-label="总点击量"]',
    );
  ...
  test("stat cards display upload stats", async ({ page }) => {
    ...
    const totalUploadsCard = uploadsSection.locator(
      '[data-testid="stat-card"][data-stat-label="总上传数"]',
    );
    ...
    const storageCard = uploadsSection.locator(
      '[data-testid="stat-card"][data-stat-label="存储用量"]',
    );
