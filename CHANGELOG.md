...
### Fixed
- Wait ten seconds before webpage capture
- Replace screenshot providers with deletion controls
- Delete stored screenshots and queue R2 cleanup
...
### Added
- Keep repository cards equal height with at most four columns
- Analyze full READMEs with saved AI fields
...
### Fixed
- Align card actions and standardize menu icons
...
### Changed
- Point enrichment registry at lib

### Fixed
- Run suggest metadata refresh from lib
