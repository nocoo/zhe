...
import { getAuthContext, getScopedDB } from "@/lib/auth-context";
import { getLinkBySlug, slugExists } from "@/lib/db";
...
import type { ActionResult, CreateLinkInput } from "./links/types";
    ...
    if (data.slug !== undefined) {
      ...
      if (!sanitized) {
        return {
          success: false,
          error:
            "Invalid slug: only letters, numbers, hyphens and underscores allowed (1-50 chars)",
        };
      }
